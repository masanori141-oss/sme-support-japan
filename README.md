...
- **`crawler/fetch_private_loans.py` の `LOAN_CONFIG` には、10分類に
  実データを登録済みです（計129件）。** 内訳はカードローン32・
  教育ローン21・自動車ローン19・住宅ローン22・リフォームローン17・
  不動産担保ローン6・投資不動産ローン5・目的型ローン5・
  証券担保ローン1（その他ローンは該当商品なしのため0件）。
  ソニー銀行・SBI新生銀行のカードローン、東京スター銀行の教育
  ローン・自動車ローン・リフォームローン（いずれも金利年1.5%〜3.8%
  で無担保ローンラインナップとして統一）を新規登録した。
  住宅ローン・リフォームローンとも対象12地方銀行を12行全行カバー
  完了（京都銀行の住宅ローンは公式サイトがJS描画のため、金利情報
  サイトで確認済みの数値を採用）。
  不動産担保ローン・投資不動産ローンは、三菱UFJ銀行・みずほ銀行・
  ソニー銀行・PayPay銀行・横浜銀行・福岡銀行などで追加調査したが、
  多くは審査結果により金利が個別決定され公開情報がないことを確認した
  （千葉銀行のアパートローンと同様の傾向）。京葉銀行のアルファ
  不動産担保フリーローンのみ公開レンジ金利（年2.1%〜4.8%）が
  見つかり新規登録した。この2分類は今後も個別調査に依存し、
  地方銀行・新興銀行の大半で商品自体はあっても公開金利が
  存在しない状況が続く見込み。
  東邦銀行の教育ローン、住信SBIネット銀行（ドコモSMTBネット銀行）の
  教育・自動車・リフォームローン、楽天銀行の教育ローンは限度額のみ
  未確認（金利は確認済み）。千葉銀行のアパートローン（投資不動産
  ローン）は個別審査により金利が決定されるため非公開で、
  `confirmed=False`（総合台帳の金利順ソートには含まれない）。
  三菱UFJ銀行・PayPay銀行はフリーローン・目的型ローンとも新規受付を
  停止していることを確認したため未登録（要調査ではなく確認済みの
  「取扱なし」）。
  対象金融機関は約38社中ほぼすべてを調査済みで、分類ごとの
  登録金融機関数にも大きな差があります（証券担保ローンは楽天銀行の
  1件のみ）。
  住宅ローンは当初メガバンク・一部地銀のみだったが、「新興銀行の方が
  むしろ住宅ローンの主流」というご指摘を受け、住信SBIネット銀行
  （ドコモSMTBネット銀行）・ソニー銀行・楽天銀行・PayPay銀行・
  イオン銀行・SBI新生銀行の6行を追加（新興銀行は変動金利0.99%〜1.55%
  台が中心で、地銀・メガバンクより低い水準）。教育ローン・自動車ローン・
  リフォームローンについても、住信SBIネット銀行の「目的ローン」
  （教育・自動車・リフォームとも同一の引下げ体系）、イオン銀行の
  教育ローン・自動車ローン（イオンアシストプラン）・リフォームローン、
  楽天銀行の教育ローン（非提携型）を新たに登録した。証券担保ローンについては、みずほ信託銀行・三井住友信託
  銀行・三菱UFJ銀行・住信SBIネット銀行（ドコモSMTBネット銀行）・
  SBI新生銀行・ソニー銀行・PayPay銀行・イオン銀行の8行を追加調査
  したが、いずれも銀行自身が個人向けに有価証券担保ローンを提供して
  いる形跡は確認できなかった（確認済みの「該当なし」）。日本では
  この種のローンは銀行ではなく日本証券金融（日証金）が証券会社と
  提携して提供する「コムストックローン」等の形態が主流で、楽天銀行の
  ような銀行チャネル直販はむしろ例外的である。対象金融機関の中に
  証券会社は含まれていないため、この分類は今後も1〜数件程度に
  とどまる見込み。
  三井住友銀行の「フリーローン（標準）」は店頭表示金利（年6.625%、
  割引前）しか確認できず、他行の掲載値（優遇後金利）と比較条件が
  そろわないため目的型ローンには未登録（要調査）。
  京都銀行・北海道銀行・東邦銀行の3地方銀行は教育ローン・自動車ローン・
  リフォームローンへ、滋賀銀行・山陰合同銀行・伊予銀行・京葉銀行・
  常陽銀行・静岡銀行は教育ローン・自動車ローンへ新たに対象を拡充し、
  対象12地方銀行のうち教育ローン・自動車ローンとも12行中12行を登録
  済み（両分類とも全行カバー完了）。さらに北海道銀行・福岡銀行・
  常陽銀行を住宅ローンへ拡充した（横浜銀行・千葉銀行・静岡銀行と
  合わせて6行）。
  - 信託銀行の証券担保ローン・投資不動産ローンを重点的に再調査した
    結果、みずほ信託銀行・三井住友信託銀行とも公式サイトの金利表に
    有価証券担保ローンに相当する個人向け商品の記載がなく（アパート
    ローン・住宅ローン・フリーローンのみ）、新規登録は見送った
    （確認済みの「該当なし」であり、要調査ではない）。ただし調査の
    過程で三井住友信託銀行が住宅ローン利用者限定のカードローン
    「わが家の味方」（住宅担保型）・「暮らしの味方」（無担保型）を
    扱っていることが判明し、後者をカードローンに新規登録した
    （信託銀行として初のカードローン登録）。
  - 三菱UFJ信託銀行は住宅ローン（2018年新規受付終了）・アパートローン
    （撤退済み）とも個人向け融資商品を確認できなかったため未登録
    （公式サイトで確認済みの「取扱なし」。要調査ではない）。
  - 消費者金融各社は、カードローンとは別建ての「目的型ローン」専用
    商品を確認できなかったため未登録（カードローン自体が資金使途
    自由なため、目的別の借入にはそちらで代替されている模様）。
  - あおぞら銀行・GMOあおぞらネット銀行は個人向けカードローンを
    確認できなかったため未登録（GMOあおぞらネット銀行は法人向け
    ビジネスローンが中心）。大和ネクスト銀行のフリーローンは新規
    申込受付を停止中のため見送ったが、同行の不動産投資ローン
    （大和証券紹介の富裕層向け、金利非公開）は投資不動産ローンに
    登録済み。
  - 住宅ローンは物件価格・年収等で融資額が個別に決まるため、上限
    融資額を「要確認」のままにしている。
  - 一部の商品（投資不動産ローンの三井住友信託銀行・三井住友銀行・
    大和ネクスト銀行分）は金利が非公開または未確認のため
    `confirmed=False` としており、総合台帳の金利順ソートには乗らない。
  - 東京スター銀行のように `UNSAFE_LEGACY_RENEGOTIATION_DISABLED`
    エラーで接続できないサイトが見つかったため、
    `fetch_private_loans.py` の `_LegacyTLSAdapter` に
    `OP_LEGACY_SERVER_CONNECT` を追加して対応した。

  `LOAN_CONFIG` に `LoanConfig` を1件ずつ追記していくことで拡充
  できます（Claudeに「◯◯銀行のその他ローンを調べて LOAN_CONFIG に
  追加して」と頼めば対応できます）。
